...
export const CHARACTERS: Character[] = [
  {
    ...
    name: "L'EMPOISONNÉ",
    description: "Master of toxic arts and subtle death",
    cardRange: {
      start: 'ST-01',
      end: 'ST-06',
    },
  ...
  },
  {
    ...
    name: "L'IMMOLÉ",
    description: "Consumed by eternal flames",
    cardRange: {
      start: 'ST-07',
      end: 'ST-12',
    },
  ...
  },
  {
    ...
    name: "L'ÉCORCHÉ",
    description: "Bearer of endless pain",
    cardRange: {
      start: 'ST-13',
      end: 'ST-18',
    },
  ...
  },
  {
    ...
    name: "L'ÉCARTELLÉ",
    description: "Torn between life and death",
    cardRange: {
      start: 'ST-19',
      end: 'ST-24',
    },
